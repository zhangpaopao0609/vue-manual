...
function isEqual(oldVal, newVal) {
...
const mutableInstrumentations = {
  ...
  set(key, val) {
    ...
    const res = this.set(key, getRawVal(val));
    if(!hasKey) {
      trigger(this, key, TriggerType.ADD);
    } else if(isEqual(oldVal, val)) {
      trigger(this, key, TriggerType.SET)
    }
    return res;
  }
}
